...
/**
 * An activity representing a single Status detail screen. This activity is only
 * used on handset devices. On tablet-size devices, item details are presented
 * side-by-side with a list of items in a {@link StatusListActivity}.
 * <p>
 * This activity is mostly just a 'shell' activity containing nothing more than
 * a {@link StatusDetailFragment}.
 */
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState == null) {
			...
			getSupportFragmentManager().beginTransaction()
					.add(R.id.status_detail_container, fragment).commit();
		}
	}
